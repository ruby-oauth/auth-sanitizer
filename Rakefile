...
# auth-sanitizer Rakefile v1.0.0 - 2026-04-06
...
# rake install                                # Build and install auth-sanitizer-1.0.0.gem in...
# rake install:local                          # Build and install auth-sanitizer-1.0.0.gem in...
# rake kettle:jem:install                     # Install auth-sanitizer GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template auth-sanitizer against itse...
# rake kettle:jem:template                    # Template auth-sanitizer files into the curren...
