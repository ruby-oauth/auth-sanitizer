...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/auth/sanitizer/my_class.rb` -> `spec/auth/sanitizer/my_class_spec.rb`.
...
[🧪build]: https://github.com/kettle-rb/auth-sanitizer/actions
[🤝conduct]: https://gitlab.com/kettle-rb/auth-sanitizer/-/blob/main/CODE_OF_CONDUCT.md
