...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "https://auth-sanitizer.galtzo.com"
  ...
  # The 'git' gem is optional; auth-sanitizer falls back to shelling out to `git` if it is not present.
